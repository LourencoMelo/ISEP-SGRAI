...
export default class Ball extends THREE.Mesh {
    ...
    update(deltaT) {
        ...
        if (centerIncrement.y < 0 && -this.table.halfSize.y + this.radius > this.center.y || // The ball is moving down and hit the bottom line
            centerIncrement.y > 0 && this.table.halfSize.y - this.radius < this.center.y) { // The ball is moving up and hit the top line
            this.direction *= -1; // The ball rebounds
